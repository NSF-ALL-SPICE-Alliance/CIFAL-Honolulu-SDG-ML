...
library(pheatmap)
library(here)
library(plyr) #wierd interaction that stops here form working
```
...
```{r}
f <- pheatmap(sdg_na_percentages_matrix, treeheight_row = 0, treeheight_col = 0, display_numbers = TRUE, fontsize_number = 6, angle_col = 45)
```
