...
```{r}
sdg_indicators_ClustImpute_no_variance <- sdg_indicators_ClustImpute_no_variance[-35,]
```

```{r}
sdg_indicators_ClustImpute_no_variance <- sdg_indicators_ClustImpute_no_variance[-5,]
```
...
```{r}
set.seed(3)
kmeans2 <- kmeans(sdg_indicators_ClustImpute_no_variance, center = 3, nstart = 100)
```
